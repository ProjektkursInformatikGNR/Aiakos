...
namespace WahlzettelAnalyse
{
    public partial class DataAdministration : Form
    {
        ...
        public DataAdministration(ref DataAccess da)
        {
            ...
            copyIcon = new Bitmap(assembly.GetManifestResourceStream("WahlzettelAnalyse.copy.png"));
            pasteIcon = new Bitmap(assembly.GetManifestResourceStream("WahlzettelAnalyse.paste.png"));
            cutIcon = new Bitmap(assembly.GetManifestResourceStream("WahlzettelAnalyse.cut.png"));
            removeIcon = new Bitmap(assembly.GetManifestResourceStream("WahlzettelAnalyse.remove.png"));
            ...
            foreach (KeyValuePair<int, Course> course in Form1.courses)
            {
            ...
            foreach (KeyValuePair<int, Student> student in Form1.students)
            {
